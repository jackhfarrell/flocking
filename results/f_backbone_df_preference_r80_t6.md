...
- `zeta = 1/z = 0.4600`
- `z = 2.1739`
- Interpreting `z = 2 d_f`: `d_f = 1.0870`
- Reduced `chi^2 = 235.8429`

## Fixed-exponent checks

| target | zeta | z | implied d_f | best eta_F | reduced chi^2 | ratio to best |
|---|---:|---:|---:|---:|---:|---:|
| SAW contour | 0.3750 | 2.6667 | 1.3333 | 0.3100 | 237.9197 | 1.0088 |
| lab diffusion | 0.5000 | 2.0000 | 1.0000 | 0.3400 | 258.2074 | 1.0948 |
| straight contour | 0.5000 | 2.0000 | 1.0000 | 0.3400 | 258.2074 | 1.0948 |
| older 1/3 check | 0.3333 | 3.0000 | 1.5000 | 0.2900 | 238.7409 | 1.0123 |
